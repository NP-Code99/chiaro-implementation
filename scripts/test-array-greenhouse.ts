/**
 * Test Greenhouse fill on Array.
 * Run: npx tsx scripts/test-array-greenhouse.ts
 */
...
const TARGET_URL = 'https://job-boards.greenhouse.io/array/jobs/6000152004?gh_jid=6000152004&utm_source=startup.jobs&utm_medium=organic'
...
async function main() {
  ...
  const applicationId = `array-test-${nanoid(8)}`
  console.log(`\nID: ${applicationId}\nURL: ${TARGET_URL}\n`)
