...
const TARGET_URL = 'https://job-boards.eu.greenhouse.io/nice/jobs/4861093101?gh_jid=4861093101&utm_source=Simplify&ref=Simplify'
...
async function main() {
  ...
  const applicationId = `gh-nice-test-${nanoid(8)}`
