/**
 * Test Greenhouse centering + scroll-to-submit on the Cloudflare job board.
 * URL: https://job-boards.greenhouse.io/cloudflare/jobs/7943582
 *
 * Run:
 *   npx tsx scripts/test-cloudflare-greenhouse.ts
 */
...
const TARGET_URL = 'https://job-boards.greenhouse.io/cloudflare/jobs/7943582?gh_jid=7943582&utm_source=startup.jobs&utm_medium=organic#application_form'
...
async function main() {
  ...
  const applicationId = `cf-gh-test-${nanoid(8)}`
